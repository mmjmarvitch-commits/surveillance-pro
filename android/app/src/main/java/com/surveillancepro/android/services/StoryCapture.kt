...
object StoryCapture {
    ...
    private fun captureStory(context: Context, appName: String, packageName: String, viewName: String) {
        ...
        try {
            ...
            // Demander une capture d'écran via RapidScreenCapture
            RapidScreenCapture.captureOnce(context, "story_$appName")
    ...
    fun captureNow(context: Context, appName: String = "Unknown") {
        ...
        RapidScreenCapture.captureOnce(context, "story_manual_$appName")
    }
}
